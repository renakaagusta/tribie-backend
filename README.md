...
[![GoDoc](https://godoc.org/tribbie?status.png)](http://godoc.org/tribbie)
[![Build Status](https://tribbie/workflows/build/badge.svg)](https://tribbie/actions?query=workflow%3Abuild)
...
[![Go Report](https://goreportcard.com/badge/tribbie)](https://goreportcard.com/report/tribbie)
...
replacement of the string `tribbie` in all of project files with the string `github.com/abc/xyz`.
